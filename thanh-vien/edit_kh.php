...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script>
            ...
            window.location.href = 'index.php?quanli=danh-sach-khach-hang'; // Chuyển hướng về danh sách khách hàng
          </script>";
    ...
    <article class="card">
        ...
        <div class="card-body mt-2">
            <form method="POST" id="updateForm">
                ...
                <a href="index.php?quanli=danh-sach-khach-hang" class="btn btn-secondary">Quay lại danh sách</a>
            </form>
        </div>
    </article>
</div>
