<?php
    $list_users = $CustomerModel->select_users(1);
    $role = 1;
...
<div class="container-fluid pt-4 px-4">
    <div class="bg-light text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h6 class="mb-0">Danh sách tài khoản nhân viên</h6>
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0" id="users-list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Nhân viên </td>
                        <td>
                            <a href="index.php?quanli=sua-tai-khoan-nv&id=<?=$username?>" class="btn btn-warning">Sửa</a>
                        </td>
                    </tr>
                    <?php
                    }
